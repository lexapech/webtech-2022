            ...
            if (layer.type === "objectgroup") {
                ...
                for (let obj of layer.objects) {
                    ...
                    entities.push({
                        ...
                        name: obj.name,
                        id: obj.id,
                        health:obj.properties?obj.properties.find(x=>x.name==="health").value:undefined,
                        collision_size:obj.properties?obj.properties.find(x=>x.name==="collision_size").value:undefined,
                        radius:obj.properties?obj.properties.find(x=>x.name==="radius").value:undefined,
                        visible: obj.visible,
